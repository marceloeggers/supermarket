...
public class EditarPedido extends javax.swing.JFrame {
  ...
  //  private ManejoXMLProducto.agregarArchivo archi = new ManejoXMLProducto.;
    ...
    private void initComponents() {
        ...
        jTextEstatus.setEditable(false);
        jTextEstatus.setBounds(180, 150, 150, 20);
        jLPFondo.add(jTextEstatus, javax.swing.JLayeredPane.DEFAULT_LAYER);
    ...
    private void jCBProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCBProductoActionPerformed
     ...
     if (jCBProducto.getSelectedIndex()==0){
      ...
      xmlproducto.cargarInformacionPedido(jCBProducto.getSelectedItem(),jTFNombre, jTFObservacion,jTFCantidad,jTextEstatus);
   ...
   private void initMyOwnComponents()
    {
           ...
           List <Pedido> lista =  com.devolverPedido();
           
           //System.out.println("LISTA:  "+ lista.get(0).getNombreProducto());
          
          xmlproducto.borrarXMLPedido();
          xmlproducto.logralo(lista);
          xmlproducto.cargarListaPedidoEnCombo(this.jCBProducto,(Integer.toString(distribuidos.Distribuidos.idAux.getId())),false);
